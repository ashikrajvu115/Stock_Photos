        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                <?php
                    ...
                    $name=mysqli_real_escape_string($bd->link,$_POST['name']);
                    ...
                    if ($name == "" || $body == ""){
                      echo "<span style='color:red; font-size:25px;'>Flied Must Not Be Empty</span>";
                        ...
                        if ($insert_post) {
                             echo "<span style='color:green; font-size:25px;'>Pages Created</span>";
                        }else{
                          echo "<span style='color:green; font-size:25px;'>Pages not Created</span>";  
                        }
                    }
